                ...
                dbc.PopoverBody(
                    [
                        dcc.Link(
                            [
                                html.I(
                                    className="fas fa-arrow-right-from-bracket me-1"
                                ),
                                "Logout",
                            ],
                            href="/logout",
...
logged_out_info = dbc.NavItem(dbc.NavLink("Login", href="/login"))


@callback(Output("user-status-header", "children"), Input("url-login", "pathname"))
